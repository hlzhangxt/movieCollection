...
public class AddEditFragment extends Fragment
{
   ...
   private EditText leadingEditText;
      ...
      Bundle savedInstanceState)
   {
      ...
      leadingEditText = (EditText) view.findViewById(R.id.leadingEditText);
      ...
      if (movieInfoBundle != null)
      {
         ...
         lengthEditText.setText(movieInfoBundle.getString("length"));  
         countryEditText.setText(movieInfoBundle.getString("country"));  
         yearEditText.setText(movieInfoBundle.getString("year"));  
         leadingEditText.setText(movieInfoBundle.getString("leading"));  
      } 
      ...
      if (movieInfoBundle == null)
      {
         // insert the contact information into the database
          rowID = databaseConnector.insertMovie(
            ...
            leadingEditText.getText().toString());
      } 
      else
      {
