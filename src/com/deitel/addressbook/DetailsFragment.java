...
public class DetailsFragment extends Fragment
{
      ...
      Bundle savedInstanceState)
   {
      ...
      // get the EditTexts
      nameTextView = (TextView) view.findViewById(R.id.titleTextView);
      phoneTextView = (TextView) view.findViewById(R.id.yearTextView);
      emailTextView = (TextView) view.findViewById(R.id.dirctorTextView);
