...
public class AddEditFragment extends Fragment
{
      ...
      Bundle savedInstanceState)
   {
      ...
      nameEditText = (EditText) view.findViewById(R.id.titleEditText);
      phoneEditText = (EditText) view.findViewById(R.id.yearEditText);
      emailEditText = (EditText) view.findViewById(R.id.directorEditText);
